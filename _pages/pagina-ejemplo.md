...
layout: page
permalink: >
  http://inthemap.epizy.com/pagina-ejemplo/
published: true
...
<!-- wp:paragraph -->
<p>Como nuevo usuario de WordPress, deberías ir a <a href="http://inthemap.epizy.com/wp-admin/">tu escritorio</a> para borrar esta página y crear nuevas páginas para tu contenido. ¡Pásalo bien!</p>
<!-- /wp:paragraph -->